...
SRCS = main.cpp src/engine/gameCharacter.cpp src/game/player.cpp src/game/bot.cpp src/game/game.cpp src/engine/member.cpp src/engine/gun.cpp src/engine/bullet.cpp src/engine/crossair.cpp
OBJS = $(SRCS:.cpp=.o)
