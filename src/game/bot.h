...
class Bot : public BbopDrawable {
      public:
         ...
         *
         * @return true si le bot est a une certaine distance de la zone de
         * patrouille
         */
        bool patrolZone();
        /**
        ...
        enum class State { patrol = 1, seek = 2, engage = 3, interaction = 4 };
        /**
         ...
         * @param perso1 joueur principale(pourra etre remplacer par liste si
         * plusieur joueur)
      ...
      protected:
        ...
        float fov;                 // fov/
        Vector2f SeekPosition;     // dernier point du joueur avant de sortir du
                               // champVisuel//
